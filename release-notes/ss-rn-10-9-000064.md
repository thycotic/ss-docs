[title]: # (Secret Server Release Notes 10.9.000064)
[tags]: # (Release Notes)
[priority]: # (1000)
...
- Fixed an issue where execution times were longer than expected for SSH scripts via the Password Changers (HB/RPC), Discovery, or Hooks for checkin and checkout was waiting the full timeout period.
