...
- 164149: The search filter now has a new optional property to tell SS to not get the total number of matching secrets when getting the current page results. Defaults to getting the total to be backwards-compatible with previous API versions.
