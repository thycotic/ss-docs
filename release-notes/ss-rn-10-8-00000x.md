...
- 164149 - Enhanced search performance in the new UI for instances with large numbers of secrets. Some enhancements automatically apply during the upgrade, but to fully take advantage of search optimization updates, customers should request assistance from Thycotic's Support team to apply new advanced settings after upgrade.
