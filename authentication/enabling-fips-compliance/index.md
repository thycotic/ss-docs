...
$1
$21. In the left pane, drill down to **Security Settings \> Local Policies \> Security Options**.
$1
$21. Click to enable the **Enabled** selection button on the **Local Security Setting** tab.
$1
$21. Close the **Local Security Policy** application.
